...
#SPI_DEVICES += atmega645a
#SPI_DEVICES += atmega645p
SPI_DEVICES += atmega649
#SPI_DEVICES += atmega649a
...
#SPI_DEVICES += atmega6450a
#SPI_DEVICES += atmega6450p
SPI_DEVICES += atmega6490
#SPI_DEVICES += atmega6490a
#SPI_DEVICES += atmega6490p
...
SPI_TARGETS=$(SPI_DEVICES:%=$(OUTDIR_LIB)/%/libspi.a)

SPI_OBJDIRS=$(SPI_DEVICES:%=$(OBJDIR)/%)
SPI_OUTDIRS=$(SPI_DEVICES:%=$(OUTDIR_LIB)/%)

SPI_HEADER = $(OUTDIR_HEADER)/spi.h

$(OBJDIR)/%/spi.o : spi.c spi.h
	$(CC) -c -mmcu=$* $(ALL_CFLAGS) $< -o $@

$(OUTDIR_LIB)/%/libspi.a: $(SPI_OBJS)
	$(AR) $@ $(OBJDIR)/$*/spi.o
