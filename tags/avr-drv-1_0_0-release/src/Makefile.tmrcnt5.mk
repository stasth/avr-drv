...
TMRCNT5_TARGETS=$(TMRCNT5_DEVICES:%=$(OUTDIR_LIB)/%/libtmrcnt5.a)

TMRCNT5_OBJDIRS=$(TMRCNT5_DEVICES:%=$(OBJDIR)/%)
TMRCNT5_OUTDIRS=$(TMRCNT5_DEVICES:%=$(OUTDIR_LIB)/%)

TMRCNT5_HEADER = $(OUTDIR_HEADER)/tmrcnt5.h

$(OBJDIR)/%/tmrcnt5.o : tmrcnt5.c tmrcnt5.h
	$(CC) -c -mmcu=$* $(ALL_CFLAGS) $< -o $@

$(OUTDIR_LIB)/%/libtmrcnt5.a: $(TMRCNT5_OBJS)
	$(AR) $@ $(OBJDIR)/$*/tmrcnt5.o
